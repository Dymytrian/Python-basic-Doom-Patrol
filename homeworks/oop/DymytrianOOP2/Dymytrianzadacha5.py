...
class Laptop:
    def __init__(self):
        ...
        self.batteries = (battery_1, battery_2, battery_3)
...
laptop = Laptop ()
print (laptop.batteries[1].capacity)
print (laptop.batteries[2].capacity)
...
phonebook = AddressBookDataClass (key = 1, name = 'Andriy', phone_number = '1234567',
                               address = 'Lviv, Shevchenka 10', email = 'abcd@gmail.com', birthday = '01.01.91',
                                  age = 25)
print (phonebook)
...
AddressBookDataClass = namedtuple ('AddressBookDataClass', ['key', 'name', 'phone_number', 'adress', 'email', 'birthday',
                                                           'age'])
...
class AddressBook:
    ...
    def __str__(self):
        return f'AdressBook {self.key}, {self.name}, {self.phone_number}, {self.adress}, {self.email}, {self.birthday},' \
               f'{self.age}'
